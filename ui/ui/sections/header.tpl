    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{$_url}dashboard" class="logo">
                <span class="logo-lg"><img src="https://clerkex.xyz/assets/img/cover.png"></span>
            ...
            <section class="sidebar">
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    {if $_admin['user_type'] eq 'Admin'}
                        ...
                        <li class="{if $_system_menu eq 'expanse'}active{/if} treeview">
                            <a href="#">
                                <i class="ion ion-minus-round"></i> <span>Expanse</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li {if $_routes[1] eq 'list'}class="active" {/if}><a
                                        href="{$_url}expanse/list">All Expanse</a></li>
                                <li {if $_routes[1] eq 'add'}class="active" {/if}><a
                                        href="{$_url}expanse/add">Add Expanse</a></li>        
                        ...
                        <li class="{if $_system_menu eq 'reports'}active{/if} treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li {if $_routes[1] eq 'by-btrc'}class="active" {/if}><a
                                        href="{$_url}reports/btrc">{$_L['BTRC_Reports']}</a></li>        
                                {$_MENU_REPORTS}
                            </ul>
                        </li>
                        ...
                        <li class="{if $_system_menu eq 'settings'}active{/if} treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li {if $_routes[1] eq 'dbstatus'}class="active" {/if}></li>
                                {$_MENU_SETTINGS}
                            </ul>
                        </li>
